...
20.times{
  ...
  testimage = ProductImage.create(image:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSVsWF8d98YVYq21f9bRkgwCUrw7nlKXmXVriBWyLZDL3OEXtzE5A", product_id: product.id)
}

# 工事中
50.times{
  testimage = ProductImage.create(image:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSVsWF8d98YVYq21f9bRkgwCUrw7nlKXmXVriBWyLZDL3OEXtzE5A", product_id: rand(1..Product.count))
  # debugger
}
